...
class ScmManagerSvnRepositoryBrowserTest {
    ...
    @Test
    void shouldReturnDiffURL() throws IOException {
    ...
    @Test
    void shouldReturnDiffURLEvenForNonEdits() throws IOException {
    ...
    @Test
    void shouldReturnDiffAnchorWithoutLeadingSlash() throws IOException {
    ...
    @Test
    void shouldReturnSourceURL() throws IOException {
    ...
    @Test
    void shouldReturnDiffURLForDeletion() throws IOException {
